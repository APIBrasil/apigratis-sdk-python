...
Regenerar: python scripts/codegen.py
...
CONSULTA_TIPOS: Dict[str, Dict[str, object]] = {
...
def consulta_tipo(tipo: str) -> Optional[Dict[str, object]]:
    """Metadados de um tipo de consulta (``None`` quando desconhecido)."""
    return CONSULTA_TIPOS.get(tipo)


def service_actions(service: str) -> List[str]:
